...
proto-oceans, where evidence of compression may be found (e.g. flower structures on seismic setcions) but the amount of shortening will be small (less than 10 km?) on the 
...
turns into (noraml) ocean growth rates that continue, in many cases to the present day. A new ridge system becomes continuous all the way from West Africa to Australia while, with a short-lived
 deviation (*sidestep*) around 130 Ma, the old-established spreading between Africa and Antarctica carries on undiminshed.

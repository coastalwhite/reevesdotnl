---
date: "2023-11-24"
title: "A Global Reference Frame A: - Large Igneous Provinces"
---

![LIPs realted to plume heads - animation may take a few second to load](http://www.reeves.nl/upload/LIP-3-text.gif)
...
(e.g. Cameroon volcanic line) but lack the large areas of initial extrusion.
 ...
 plume central in Gondwana disruption.  A fuller explanation is given in Reseacrh Update No.21. Areas of basalt are shown in red-brown, appearing at a time that reflects
 the dates published, where available. Some of the known dyke swarms are shown as purple lines (e.g. the Okavango dyke swarm in southern Africa) and a few large

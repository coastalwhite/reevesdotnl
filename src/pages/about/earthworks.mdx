...
[\[link\]](http://www.reeves.nl/upload/AfricanGeodynamicsBrochure.pdf) was
...
baseline data to release to the exploration sector. Colin Reeves has been active
...
Our approach has been to face up to this challenge squarely, starting with the
...
![The post-Karroo dyke swarm in Botswana](./assets/earthworks/pic3.jpg)
...
hidden structures (such as the Okavango dyke swarm in Botswana) that not only
...
geology but also make defensible arguments embracing the geophysical anomalies
about what must lie below. It is fundamental to exploration programmes that such
...
larger entities of Precambrian rocks like Gondwana, Pangea and Rodinia.

![Combined magnetic and radiometric image](./assets/earthworks/pic4.jpg)

## The hidden two-thirds of the Earth

Most of our planet is covered by the water of the deep oceans. Their peological
history was virtually unknown until the theory of plate tectonics brought a new
dimension to earth science as a whole in the 1960s. In 1997, satellite altimetry
...
dispersed from the Paleozoic entity of Gondwana could be traced with new
accuracy over time. Making use of this data required the adoption of
...
and extended accurate reconstructions back into the Lower Cretaceous and
Jurassic where the story of Gondwana disruption is rooted. This work is ongoing.
...
given to these research activities, including support to the new Geological Map
of Gondwana (IGCP-628). Earlier contributions to basic research have included,

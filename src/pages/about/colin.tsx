    ...
    <PDFViewLayout pageName="about" pageTitle="Colin Reeves">
      <TwoArticleColumns>
        <Paragraph heading="Short curriculum vitae">
          ...
          <b>
            Colin Reeves&nbsp;
          </b>has been involved since 1970 with the application of (airborne)
        ...
        <Image
          my="4"
          src="/assets/img/about/colin/pic2.jpg"
          alt="ITC fieldwork"
          w="100%"
        />
        <Paragraph>
        ...
        <Image
          my="4"
          src="/assets/img/about/colin/pic3.jpg"
          alt="Magnetic Anomalies First Edition 1993"
          w="100%"
        />
        <Paragraph>
        ...
        <Image
          my="4"
          src="/assets/img/about/colin/pic4.jpg"
          alt="Gondwana-10"
          w="100%"
        />

        <Paragraph>
          Colin’s interest in accurately defining the process of Gondwana
        ...
        <Image
          my="4"
          src="/assets/img/about/colin/pic5.gif"
          alt="Colin Reeves"
          w="100%"
        />

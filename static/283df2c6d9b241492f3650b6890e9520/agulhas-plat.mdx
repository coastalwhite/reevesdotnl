...
Note in the animation how all these changes occur closely within the vicinity of the Bouvet plume (orange star). A number of minor and, in some cases, short-lived mid-ocean ridges create the ocean crust that separated the smaller fragments in the model.  Euler rotation parameters for all ten minor mid-ocean ridges, in addition to the three major ones around the triple junction (Africa-Antarctica, Africa-South America and Antarctica-South America) are given in the supplement section of the [latest rotation poles](https://www.reeves.nl/edcb4436f7ecca25d0e184fb91c365ac/CR26BAAE-2e.pdf) dated 2026 June 11.

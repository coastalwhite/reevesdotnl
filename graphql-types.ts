...
export type FileFieldsEnum =
  ...
  | 'childrenMarkdownRemark___frontmatter___image_path'
  | 'childrenMarkdownRemark___frontmatter___image_alt'
  | 'childrenMarkdownRemark___frontmatter___readmore_uri'
  ...
  | 'childMarkdownRemark___frontmatter___image_path'
  | 'childMarkdownRemark___frontmatter___image_alt'
  | 'childMarkdownRemark___frontmatter___readmore_uri'
...
export type MarkdownRemarkFieldsEnum =
  | 'id'
  | 'frontmatter___title'
  | 'frontmatter___image_path'
  | 'frontmatter___image_alt'
  | 'frontmatter___readmore_uri'
  | 'excerpt'
  | 'rawMarkdownBody'
  | 'fileAbsolutePath'
  | 'html'
...
export type MarkdownRemarkFrontmatter = {
  ...
  readmore_uri?: Maybe<Scalars['String']>;
};
...
export type MarkdownRemarkFrontmatterFilterInput = {
  ...
  readmore_uri?: Maybe<StringQueryOperatorInput>;
};
